...
module.exports = {
    ...
    targets: {
        ...
        './api/blueprints/_util/actionUtil.js': {
            copy: 'api/blueprints/_util/actionUtil.js'
        },
        './api/blueprints/create.js': {
            copy: 'api/blueprints/create.js'
        },
        './api/blueprints/destroy.js': {
            copy: 'api/blueprints/destroy.js'
        },
        './api/blueprints/find.js': {
            copy: 'api/blueprints/find.js'
        },
        './api/blueprints/findone.js': {
            copy: 'api/blueprints/findone.js'
        },
        './api/blueprints/populate.js': {
            copy: 'api/blueprints/populate.js'
        },
        './api/blueprints/update.js': {
            copy: 'api/blueprints/update.js'
        },
        ...
        './config/session.js': {
            template: 'config/session.js'
        },
        './config/views.js': {
            template: 'config/views.js'
        },

        './config/locales/de.json': {
            copy: 'config/locales/de.json'
        },
        './config/locales/en.json': {
            copy: 'config/locales/en.json'
        },
        './config/locales/es.json': {
            copy: 'config/locales/es.json'
        },
        './config/locales/fr.json': {
            copy: 'config/locales/fr.json'
        },
        './config/locales/_README.md': {
            copy: 'config/locales/_README.md'
        },

        './config/env/production.js': {
            copy: 'config/env/production.js'
        },
        './config/env/development.js': {
            copy: 'config/env/development.js'
        },

        './api/policies/sessionAuth.js': {
            copy: 'api/policies/sessionAuth.js'
        },

        './api/responses/badRequest.js': {
            copy: 'api/responses/badRequest.js'
        },
        './api/responses/forbidden.js': {
            copy: 'api/responses/forbidden.js'
        },
        './api/responses/notFound.js': {
            copy: 'api/responses/notFound.js'
        },
        './api/responses/serverError.js': {
            copy: 'api/responses/serverError.js'
        },
        './api/responses/ok.js': {
            copy: 'api/responses/ok.js'
        },
